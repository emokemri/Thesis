...
class OrbitWindow(ctk.CTkFrame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.btn_calculate = ctk.CTkButton(self.frm_calculate, text="Calculate Orbit")
        ...
        self.btn_file = ctk.CTkButton(self.frm_file, text="Save orbit to file")
        self.frm_file.pack()
        self.btn_file.pack()
