...
class MainController:
    ...
    def save_matrix(self, master_name) -> None:
        ...
        for i in range(dimension):
            for j in range(dimension):
                if int(children[index].get()) > sys.maxsize:
                    error = True
                    break
                try:
    ...
    def combobox_selection_changed(self, choice):
        ...
        if choice == "Custom":
            ...
            #self.frame.btn_save_digits.pack_forget()
    ...
    def load_from_file(self) -> None:
        ...
        try:
            with open(filepath, mode="r", encoding="utf-8") as input_file:
                ...
                if isinstance(data["digits"], str) and data["digits"].startswith("canonical"):
                ...
                elif isinstance(data["digits"], str) and data["digits"].startswith("symmetrical"):
    ...
    def open_new_window(self) -> None:
        ...
        elif self.model.radix.is_not_GNS():
            lbl_error = ctk.CTkLabel(self.frame.frm_open_new_window, text="The given system is not a number system", text_color="red")
            lbl_error.pack()
